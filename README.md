...
The algorithm definitions, COSE test vectors, RFC 8792-folded presentation
copies of the test vectors, and several draft sections (algorithm tables,
IANA registrations, test vectors appendix) are generated by automation that is
maintained in the companion JOSE repository and invoked through this
repository's `package.json` scripts.
...
3. Regenerate RFC 8792-folded presentation copies under `examples/folded/`
